...
public class StartTestActivity extends AppCompatActivity {
    ...
    private void addControls() {
        ...
        deAdapter = new DeAdapter(StartTestActivity.this, R.layout.item_de, arrDe);
    ...
    private void addEvents() {
        ...
        gvDe.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //TODO:  Truyền mã đề qua activity
                Intent intent = new Intent(StartTestActivity.this,DetailTestActivity.class);
